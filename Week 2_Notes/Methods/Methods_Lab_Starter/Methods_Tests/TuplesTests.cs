...
namespace Methods_Tests
{
    ...
    public class PowersRootTests
    {
        [TestCase(1)]
        public void GivenAPositiveInteger_PowersRoot_ReturnsCorrectValuesOfSquareCubeAndRoot(int answerSquare, int answerCube, double answerRoot)
        {
            var answer = Methods.PowersRoot(number);
            Assert.That(answerSquare, Is.EqualTo()
